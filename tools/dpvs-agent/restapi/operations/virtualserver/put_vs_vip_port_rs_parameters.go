...
//
// swagger:parameters PutVsVipPortRs
type PutVsVipPortRsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewPutVsVipPortRsParams() beforehand.
func (o *PutVsVipPortRsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *PutVsVipPortRsParams) bindVipPort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
